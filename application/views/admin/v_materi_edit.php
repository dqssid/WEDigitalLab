<div class="container">
 ...
 <div class="card-body">
 <a href="<?php echo base_url().'materi/materi_edit' ?>" class='btn btn-sm btn-light
btn-outline-dark pull-right'><i class="fa fa-arrow-left"></i> Kembali</a>
 <br/>
 <br/>
 <?php foreach($buku as $b){ ?>
 <form method="post" action="<?php echo base_url().'materi/materi_edit';
?>">
...
placeholder="Masukkan nama penulis" required="required" value="<?php echo $b->penulis; ?>">
 </div>
 </div>
 <div class="form-group">
